...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cdleeoqukbez.us-east-1.rds.amazonaws.com',  #database endpoint
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesdamlablog' # please enter your s3 bucket name
